...
@XmlType(name = "ImageryMetadataOptions", namespace = "http://dev.virtualearth.net/webservices/v1/imagery", propOrder = {
    "heading",
    "location",
...
public class ImageryMetadataOptions {
    ...
    @XmlElement(name = "ReturnImageryProviders", namespace = "http://dev.virtualearth.net/webservices/v1/imagery")
