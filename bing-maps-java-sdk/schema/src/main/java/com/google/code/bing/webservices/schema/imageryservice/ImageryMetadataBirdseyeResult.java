...
@XmlType(name = "ImageryMetadataBirdseyeResult", namespace = "http://dev.virtualearth.net/webservices/v1/imagery", propOrder = {
    "heading",
    "tilesX",
    "tilesY"
})
    ...
    extends ImageryMetadataResult
{
    ...
    @XmlElement(name = "TilesX", namespace = "http://dev.virtualearth.net/webservices/v1/imagery")
    protected Integer tilesX;
    @XmlElement(name = "TilesY", namespace = "http://dev.virtualearth.net/webservices/v1/imagery")
