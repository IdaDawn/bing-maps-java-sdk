...
@XmlType(name = "UserProfile", namespace = "http://dev.virtualearth.net/webservices/v1/common", propOrder = {
    "currentHeading",
    "currentLocation",
    "deviceType",
    "distanceUnit",
...
public class UserProfile {
    ...
    @XmlElement(name = "DeviceType", namespace = "http://dev.virtualearth.net/webservices/v1/common")
    protected DeviceType deviceType;
    @XmlElement(name = "DistanceUnit", namespace = "http://dev.virtualearth.net/webservices/v1/common")
