...
@XmlType(name = "Heading", namespace = "http://dev.virtualearth.net/webservices/v1/common", propOrder = {
    "orientation"
})
public class Heading {

    @XmlElement(name = "Orientation", namespace = "http://dev.virtualearth.net/webservices/v1/common")
