...
import com.bing.maps.rest.schema.AddressComponentType;
import com.bing.maps.rest.schema.GeoLocation;
import com.bing.maps.rest.schema.LocationType;
import com.bing.maps.rest.schema.TravelMode;
import com.bing.maps.rest.services.AsyncResponseHandler;
import com.bing.maps.rest.services.BingMapsException;
import com.bing.maps.rest.services.BingMapsQuery;
import com.bing.maps.rest.services.InvalidRequestException;
import com.bing.maps.rest.services.NotFoundException;
import com.bing.maps.rest.services.OverQueryLimitsException;
import com.bing.maps.rest.services.RequestDeniedException;
import com.bing.maps.rest.services.constant.BingMapsApiUrls.GoogleMapsApiUrlBuilder;
...
import com.googleapis.maps.services.ApplicationConstants;
import com.googleapis.maps.services.GoogleMapsApiGateway;

/**
 * The Class BaseGoogleMapsApiQuery.
 */
public abstract class BaseBingMapsApiQuery<T> extends GoogleMapsApiGateway implements BingMapsQuery<T> {
	 ...
	 */
	public BaseBingMapsApiQuery(String applicationId) {
	 ...
	 */
	public BaseBingMapsApiQuery(String applicationId, String apiVersion) {
		this(applicationId);
	 ...
	 */
	protected BingMapsException createGoogleMapsException(String statusCode) {
