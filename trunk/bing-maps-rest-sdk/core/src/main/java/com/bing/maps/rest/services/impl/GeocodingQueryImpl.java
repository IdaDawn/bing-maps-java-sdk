 ...
 */
public class GeocodingQueryImpl extends BaseBingMapsApiQuery<GeocodingResult> implements
	GeocodingQuery {
	...
	@Override
	public void reset() {
		apiUrlBuilder = createGoogleSearchApiUrlBuilder(BingMapsApiUrls.GEOCODE_URL);
	}
