...
public final class BingMapsApiUrls {
    ...
    public static final String GEOCODE_URL =
        googleApiUrls.getProperty("com.googleapis.maps.services.geocode");
    
    /** The Constant DIRECTIONS_URL. */
    public static final String DIRECTIONS_URL =
        googleApiUrls.getProperty("com.googleapis.maps.services.directions");

    /** The Constant ELEVATION_URL. */
    public static final String ELEVATION_URL =
        googleApiUrls.getProperty("com.googleapis.maps.services.elevation");
