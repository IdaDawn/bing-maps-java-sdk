 ...
 * 
 */
package com.bing.maps.rest.services.example;
...
import com.bing.maps.rest.schema.AddressComponent;
import com.bing.maps.rest.schema.GeocodingResult;
import com.bing.maps.rest.services.GeocodingQuery;
import com.bing.maps.rest.services.BingMapsQueryFactory;
import com.googleapis.maps.services.GeocodingSample;
...
public class GeocodingSample {
    ...
    private static void processCommandLine(CommandLine line, Options options) {
        if(line.hasOption(HELP_OPTION)) {
    		...
    		BingMapsQueryFactory factory = BingMapsQueryFactory.newInstance(line.getOptionValue(APPLICATION_KEY_OPTION));
