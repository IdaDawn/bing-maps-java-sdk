...
@XmlType(name = "Circle", namespace = "http://dev.virtualearth.net/webservices/v1/common", propOrder = {
    "center",
    "distanceUnit",
    "radius"
})
    ...
    extends ShapeBase
{
    ...
    @XmlElement(name = "Radius", namespace = "http://dev.virtualearth.net/webservices/v1/common")
