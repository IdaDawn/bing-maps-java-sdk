...
@XmlType(name = "ArrayOfImageryProvider", namespace = "http://dev.virtualearth.net/webservices/v1/imagery", propOrder = {
    "imageryProvider"
})
public class ArrayOfImageryProvider {

    @XmlElement(name = "ImageryProvider", namespace = "http://dev.virtualearth.net/webservices/v1/imagery", nillable = true)
