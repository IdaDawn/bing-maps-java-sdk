...
@XmlType(name = "ResponseSummary", namespace = "http://dev.virtualearth.net/webservices/v1/common", propOrder = {
...
public class ResponseSummary {
    ...
    @XmlElement(name = "AuthenticationResultCode", namespace = "http://dev.virtualearth.net/webservices/v1/common")
    ...
    @XmlElement(name = "StatusCode", namespace = "http://dev.virtualearth.net/webservices/v1/common")
