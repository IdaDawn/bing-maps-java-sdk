...
@XmlType(name = "ArrayOfImageryMetadataResult", namespace = "http://dev.virtualearth.net/webservices/v1/imagery", propOrder = {
    "imageryMetadataResult"
})
public class ArrayOfImageryMetadataResult {

    @XmlElement(name = "ImageryMetadataResult", namespace = "http://dev.virtualearth.net/webservices/v1/imagery", nillable = true)
