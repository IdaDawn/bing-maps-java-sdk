...
@XmlType(name = "UserLocation", namespace = "http://dev.virtualearth.net/webservices/v1/common", propOrder = {
    "confidence"
})
    ...
    extends Location
{
    ...
    @XmlElement(name = "Confidence", namespace = "http://dev.virtualearth.net/webservices/v1/common")
