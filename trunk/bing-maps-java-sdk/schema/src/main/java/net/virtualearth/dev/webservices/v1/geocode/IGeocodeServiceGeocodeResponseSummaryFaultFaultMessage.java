...
public class IGeocodeServiceGeocodeResponseSummaryFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public IGeocodeServiceGeocodeResponseSummaryFaultFaultMessage(String message, ResponseSummary faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public IGeocodeServiceGeocodeResponseSummaryFaultFaultMessage(String message, ResponseSummary faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
