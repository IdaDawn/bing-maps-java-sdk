 ...
 *
 */
public class BingMapsSearchServiceClientException extends
	 ...
	 * @param traceId
	 */
	public BingMapsSearchServiceClientException(String message, Throwable cause, String authenticationResultCode,
